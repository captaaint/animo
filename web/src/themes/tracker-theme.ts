...
export const TrackerTheme: ThemeDefinition = {
  ...
  themeVars: {
    ...
    "border-ModalDialog": "1px solid $borderColor",
    "borderColor-ModalDialog": "$borderColor",
